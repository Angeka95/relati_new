...
export default function Footer() {
    ...
    <footer id="footer" className="width: 100%" >
     ...
     <div className="container secondary_blue" >
         <div className="footer-info row">
             <div className="col-md-3">
                 <h6>Contáctenos</h6>
                 <ul>
                     <li><span className="titlefoot">Sede principal:</span><br></br>
                         Cra 7 # 63-44, Bogotá - Colombia.</li>
                     <li><span className="titlefoot">Ventanilla única:</span><br></br>
                         Cra 7 # 63-44, Bogotá - Colombia.</li>
                     <li><span className="titlefoot">Conmutador:</span><br></br>
                         Bogotá: (+57) (601) 7440041<br></br>
                         Resto del país: 01 8000 180602</li>
             ...
             <div className="col-md-3">
                 <h6>Horarios y atención al público</h6>
                 <ul>
                     <li><span className="titlefoot">Atención presencial:</span><br></br>
                         Lunes a viernes de 8:00 a.m. a 1:00 p.m. y de 2:00 p.m. a 5:30 p.m., días hábiles.</li>
                     <li><span className="titlefoot">Recepción de correspondencia:</span><br></br>
