...
let newArrData = datos_boletines_anios.map(item => {
    return {
        id: item.id,
        titulo: null,
        idioma: "Español",
        nombre: `Boletin ${item.id}`,
        nombreWithExt: `Boletin ${item.id}.pdf`,
        pdf: item.pdf,
        fecha: item.fecha,
        facebook: item.facebook,
        twitter: item.twitter,
        mail: item.mail,
        versionIngles: item.versionIngles,
        esEspecial: item.esEspecial,
        imagenPortada: item.imagenPortada
    }; 
});

datos_boletines_anios = newArrData.concat([
    {
        "id": 325,
        "titulo": null,
        "idioma": "Español",
        "nombre": "Boletín_09_edicion-especial_2024",
        "nombreWithExt": "Boletín_09_edicion-especial_2024.pdf",
        "pdf": "https://relatoria.jep.gov.co/documentos/providencias/17/23/Boletín_09_edicion-especial_2024.pdf",
        "fecha": "2024-09-01",
        "facebook": "https://www.facebook.com/sharer.php?u=https://relatoria.jep.gov.co/documentos/providencias/17/23/Boletín_09_edicion-especial_2024.pdf",
        "twitter": "https://twitter.com/intent/tweet?text=Boletín_09_edicion-especial_2024&url=documentos/providencias/17/23/Boletín_09_edicion-especial_2024.pdf",
        "mail": true,
        "versionIngles": "https://relatoria.jep.gov.co/documentos/providencias/17/23/en/boletin_eng_diciembre_2022.pdf",
        "esEspecial": true,
        "imagenPortada": ""
...
export default datos_boletines_anios;