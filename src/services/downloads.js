...
const getDownloadResultsZIP = async ( stringURL, stringParams ) => {
  try {
    const config = {
        headers: {
          'Authorization': `Bearer ${process.env.REACT_APP_API_ACCESS_TOKEN}`,
...
const getDownloadFiles = async ( stringURL, stringParams ) => {
  try {
    const config = {
        headers: {
          'Authorization': `Bearer ${process.env.REACT_APP_API_ACCESS_TOKEN}`,
...
export { getDownloadResultsXLS, getDownloadResultsXLST , getDownloadResultsZIP, getDownloadFiles };