...
export default function ButtonDownloadXLS({ stringURL, stringParams, datosToExport, filename = 'archivo.xls' }) {
  ...
  return (
    ...
    <>
        ...
        <a className="link_primary vertical_align" onClick={getDownloadLink} disabled={loading}>
